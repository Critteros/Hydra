export enum PrismaErrorCode {
   ...
   * {@link http://pris.ly/d/connection-pool} (Current connection pool timeout: {timeout},
  ...
  /**
   * Prisma needs to perform transactions, which requires your MongoDB server to be run as a
   * replica set. See details: {@link https://pris.ly/d/mongodb-replica-set}
   */
